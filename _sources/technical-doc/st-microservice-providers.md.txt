...
Se debe clonar el repositorio [**st-microservice-providers**](https://github.com/SwissTierrasColombia/st-microservice-providers) almacenado en github y posteriormente generar el jar del proyecto a través de maven.
